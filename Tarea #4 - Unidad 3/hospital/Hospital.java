...
public class Hospital {
    ...
    public Hospital(){
        Admin admin = new Admin("I-12345", "Admin", "Default",  LocalDate.now(),
                "4433805766", "admin123",
    ...
    public void mostrarMedicoPorID(String id) {
        ...
        if (medicoEncontrado != null) {
            ...
            System.out.println(medicoEncontrado.mostrarInformacion());
        }
        else {
    ...
    private void eliminarConsultaPorID(String idConsulta){
    ...
    public void generarExpedienteConsulta(String idConsulta, String idPaciente){
        ...
        System.out.print("Ingresa las observaciones finales de la consulta: ");
